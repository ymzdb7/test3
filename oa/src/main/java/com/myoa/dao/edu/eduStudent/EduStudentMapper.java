package com.myoa.dao.edu.eduStudent;
...
public abstract interface EduStudentMapper extends BaseMapper<EduStudent> {
	...
	public abstract List<EduStudent> selectBatchIds(
			List<? extends Serializable> paramList);

	public abstract EduStudent findUserByName(
			@Param("byname") String paramString);

	public abstract List<EduStudent> getStudentLists(
