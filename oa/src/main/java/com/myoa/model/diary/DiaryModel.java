...
public class DiaryModel {
	...
	public Integer getIsComments() {
		return Integer.valueOf(this.isComments == null ? 0 : this.isComments
				.intValue());
	}
	...
	public String getToIdName() {
		return this.toIdName == null ? "" : this.toIdName;
	}
	...
	public String getDiaTime() {
		return this.diaTime == null ? "" : this.diaTime;
	}
	...
	public String getLastCommentTime() {
		return this.lastCommentTime == null ? "" : this.lastCommentTime;
	}
