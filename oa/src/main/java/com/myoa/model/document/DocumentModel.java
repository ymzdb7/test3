 ...
 public class DocumentModel
 {
   ...
   private String wordAttUrl;
   private String aipAttUrl;
  ...
  {
    this.docNo = (docNo == null ? "" : docNo.trim());
  }
  ...
  {
    this.urgency = (urgency == null ? "" : urgency.trim());
  }
  ...
  {
    this.secrecy = (secrecy == null ? "" : secrecy.trim());
  }
 ...
 {
   this.mainDelivery = (mainDelivery == null ? "" : mainDelivery.trim());
 }
 ...
 {
   this.copyDelivery = (copyDelivery == null ? "" : copyDelivery.trim());
 }
 ...
 {
   this.creater = (creater == null ? "" : creater.trim());
 }
 ...
 {
   this.createDept = (createDept == null ? "" : createDept.trim());
 }
 ...
 {
   this.printDept = (printDept == null ? "" : printDept.trim());
 }
  ...
  {
    this.dispatchType = (dispatchType == null ? "" : dispatchType.trim());
  }
  ...
  {
    this.mainFile = (mainFile == null ? "" : mainFile.trim());
  }
  ...
  {
    this.mainFileName = (mainFileName == null ? "" : mainFileName.trim());
  }
  ...
  {
    this.mainAipFile = (mainAipFile == null ? "" : mainAipFile.trim());
  }
  ...
  {
    this.mainAipFileName = (mainAipFileName == null ? "" : mainAipFileName.trim());
  }
  ...
  {
    this.publicFlag = (publicFlag == null ? "" : publicFlag.trim());
  }
  ...
  {
    this.printUser = (printUser == null ? "" : printUser.trim());
  }
  ...
  public void setRunId(Integer runId)
  {
   ...
   {
     this.flowRunName = (flowRunName == null ? "" : flowRunName.trim());
   }
   ...
   {
     this.flowStatus = (flowStatus == null ? "" : flowStatus.trim());
   }
   ...
   {
     this.flowPrcs = (flowPrcs == null ? "" : flowPrcs.trim());
   }
   ...
   public void setCurUserId(String curUserId) {
     this.curUserId = (curUserId == null ? "" : curUserId.trim());
   }
   ...
   {
     this.allUserId = (allUserId == null ? "" : allUserId.trim());
   }
 
   public String getWordAttUrl() {
     return this.wordAttUrl;
   }
 
   public void setWordAttUrl(String wordAttUrl) {
     this.wordAttUrl = wordAttUrl;
   }
 
   public String getAipAttUrl() {
     return this.aipAttUrl;
   }
 
   public void setAipAttUrl(String aipAttUrl) {
     this.aipAttUrl = aipAttUrl;
   }
   ...
   public DocumentModel(Integer id, Integer flowId, Integer runId, String flowRunName, String flowStatus, String flowPrcs, String curUserId, String allUserId) {
     this.id = id;
     this.flowId = flowId;
     this.runId = runId;
