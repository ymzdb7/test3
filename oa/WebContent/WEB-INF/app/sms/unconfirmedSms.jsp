...
<table class="contentTable" style="table-layout: fixed">
    <thead>
    <tr>
        <th style="width: 5em;padding-left:10px"><fmt:message code="global.lang.select" /></th>
        <th style="width: 10%"><fmt:message code="sup.th.Sender" /></th>
        <th style="width: 18%"><fmt:message code="notice.th.type" /></th>
        <th style="width: 50%"><fmt:message code="notice.th.content" /></th>
        <th style="width: 12%"><fmt:message code="sup.th.SendingTime" /></th>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < data.obj.length; i++) {
                        ...
                        str += "<tr>" +
                            "<td  style='width: 2% ' ><input class='checkChild'  type='checkbox' bodyId='" + data.obj[i].bodyId + "' name='check' value=''></td>" +
                            "<td style='width:15%'>" + data.obj[i].fromName + "</td>" +
                            "<td style='width:15%' title='"+ data.obj[i].smsTypeName +"'>" + data.obj[i].smsTypeName + "</td>" +
                            "<td style='width: 53%' title='"+data.obj[i].content+"'>" + data.obj[i].content + "</td>" +
                            "<td style='width:15%'>" + sendTime + "</td>" +
