...
<div>
    <div class="title">
        <img src="../../img/book/yesyes.png" alt="">
        <span>已批借阅</span>
    </div>
                    ...
                    success:function(reg){
                        ...
                        for(var i=0;i<datas.length;i++){
                            ...
                            str += '<tr id="'+datas[i].borrowId+'">' +
                                ...
                                '<td>' +function (){
                                      if(datas[i].status==1){
                                          return '<a href="javascript:;" class="remove" style="margin-top:0px">删除</a>';
                                      }else{
                                          if(datas[i].renewFlag==0){
                                              return '<a href="javascript:;" class="return" style="margin-top:0px" onclick="upManage('+datas[i].borrowId+',3,1)">续借</a>&nbsp;<a href="javascript:;" class="return" style="margin-top:0px" onclick="upManage('+datas[i].borrowId+',0,3)">还书</a>';
                                          }else{
                                              return '<a href="javascript:;" class="return" style="margin-top:0px" onclick="upManage('+datas[i].borrowId+',0,3)">还书</a>';
                                          }
                                      }
                                }()+'                </td>' +
                                '            </tr>'
...
//    })
    ...
    // 还书：status=0  续借：renewFlag=1
    function upManage(borrowId,status,renewFlag) {
        $.ajax({
            url: '/bookManage/upManageById',
            type: 'get',
            dataType: 'json',
