...
<div class="divtable">
    <table class="tr_td">
        ...
        <tr>
            ...
            <td >
                <textarea name="txt" id="sms2RemindPriv" user_id=""  class="sendsave senduser" disabled rows="3" cols="50"></textarea>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $.ajax({
            url: '<%=basePath%>sms2Priv/selectSms2RemindPriv',
            dataType: 'json',
    ...
    $(function () {
        ...
        $("#okbtn").click(function () {
            $.ajax({
                type:'post',
                url: '<%=basePath%>sms2Priv/upselectSms2RemindPriv',
                dataType: 'json',
                data:{
                    sms2RemindPriv:$('[id="sms2RemindPriv"]').val()
                },
                success: function (data) {
                    if (data.flag) {
