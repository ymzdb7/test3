...
<head lang="en">
    <meta charset="UTF-8">
    <title><fmt:message  code="event.th.VehicleUse"/></title>
...
<div class="content">
    <div class="header">
        <div class="title">
            ...
            <span class="big3"><fmt:message  code="event.th.VehicleUse"/></span>
        </div>
    </div>
    <div class="main">
            ...
            success: function (result) {
                ...
                for(var i=0;i<arr.length;i++){
                    str+='<tr>'+
                        ...
                        '<a href="../../veHicle/vehicleUseApply?editFlag=1&sign=3&vuId='+arr[i].vuId+'"><fmt:message  code="menuSSetting.th.editMenu"/></a>' +
                        ' <a href="javascript:;" class="delete" onclick="delete_1('+arr[i].vuId+');">'+"<fmt:message  code="menuSSetting.th.deleteMenu"/>"+'</a>'
                    '</td>'+
                    '</tr>';
                }
