                    ...
                    if(datas.length>0){
                        for(var i=0;i<datas.length;i++){
                            var newCon =$('<tr class="conLeft cue" id='+datas[i].uuid +'>' +
                                '<td class="ellipsis" style="width:15%;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;">'+datas[i].title+'</td>' +
...
//返回
        $('#seeClass').click(function(){
            window.location.href="timeLineEvent";
        })
//        添加事件
        $('#newClass').click(function(event){
            ...
            layer.open({
                ...
                '<div class="div_tr"><span class="span_td"><fmt:message code="sup.th.startTime" />：</span><span><input type="text" style="width: 180px;" name="beginTime" class="inputTd" value="" id="beginTime" onclick="laydate({istime: true, format: \'YYYY-MM-DD hh:mm:ss\'})" /></span></div>'+
                '<div class="div_tr"><span class="span_td"><fmt:message code="meet.th.EndTime" />：</span><span><input type="text" style="width: 180px;" name="endTime" class="inputTd" value="" id="endTime" onclick="laydate({istime: true, format: \'YYYY-MM-DD hh:mm:ss\'})" /></span></div>'+
                '<div class="div_tr"><span class="span_td"><fmt:message code="notice.th.content" />：</span><span><div class="inPole"><textarea name="txt" id="textCont" value="" style="min-width: 300px;min-height:150px;margin-left:0px;"></textarea></div></span></div>'+
                '</div>',
                yes:function(index){
            ...
            $.ajax({
                ...
                success:function(reg){
                    ...
                    layer.open({
                        ...
                        '<div class="div_tr"><span class="span_td"><fmt:message code="sup.th.startTime" />：</span><span><input type="text" style="width: 180px;" name="beginTime" class="inputTd" value="'+data.startTime+'" id="beginTime" onclick="laydate({istime: true, format: \'YYYY-MM-DD hh:mm:ss\'})" /></span></div>'+
                        '<div class="div_tr"><span class="span_td"><fmt:message code="meet.th.EndTime" />：</span><span><input type="text" style="width: 180px;" name="endTime" class="inputTd" value="'+data.endTime+'" id="endTime" onclick="laydate({istime: true, format: \'YYYY-MM-DD hh:mm:ss\'})" /></span></div>'+
                        '<div class="div_tr"><span class="span_td"><fmt:message code="notice.th.content" />：</span><span><textarea name="txt" id="textCont" value="'+data.content+'" style="min-width: 300px;min-height:150px;vertical-align:top;margin-left:5px">'+data.content+'</textarea></span></div>'+
                        '</div>',
                        yes:function(index){
                            if($('#title').val().replace(/(^\s*)|(\s*$)/g, "") == ''){
                                $.layerMsg({content:'<fmt:message code="event.th.titleCannotEmpty" />！',icon:3});
            ...
            $.ajax({
                ...
                success:function(reg){
                    ...
                    layer.open({
                        ...
                        shadeClose: true, //点击遮罩关闭
                        content:'<div class="div_table">' +
                        '<div class="div_tr"><span class="span_td span_lf"><fmt:message code="notice.th.title" /><span style="color: #FF0000;margin-left: 10px;font-size: 16px;"></span>：</span><span>'+ data.title+'</span></div>'+
