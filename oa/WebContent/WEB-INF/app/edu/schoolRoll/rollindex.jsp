...
<div class="box">
    <div class="header">
        <ul class="nav">
            <li url="/schoolRoll/out">
                <span class="select pad new1">学籍转出</span>
                <img class="space" src="../../img/twoth.png" alt="">
            </li>

            <li style="margin-top:6px;" url="/schoolRoll/into">
                <span class="pad new2">学籍转入</span>
                <img class="space" src="../../img/twoth.png" alt="">
            </li>
    ...
    <div class="list" style="width:100%;height:100%">
        <%--列表展示部分--%>
        <iframe vote_id="0" id="iframe" src="/schoolRoll/out" frameborder="0" style="width:100%;height:100%"></iframe>
    </div>
</div>
