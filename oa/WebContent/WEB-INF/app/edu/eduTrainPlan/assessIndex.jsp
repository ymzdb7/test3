...
<div class="bx">
    ...
    <div class="head w clearfix">
        <ul class="index_head">
            <li url="assessManage">
                  ...
                  <fmt:message code="event.th.PendingPlan" />
                </span>
            ...
            <li url="approvalFalse">
                <span class="headli3">
               <fmt:message code="event.th.Record" />
                </span>
                <img class="headli1_2" src="../img/twoth.png" alt=""/>
            <li url="approvalQuery">
                <span class="headli3">
              <fmt:message code="event.th.ExaminationApproval" />
                </span>
               </li>
        </ul>
    </div>
    ...
    <div style="width:100%;height:100%;">
        <iframe class="contract_iframe" src="assessManage" frameborder="0" width="100%" height="100%"></iframe>
    </div>
</div>
