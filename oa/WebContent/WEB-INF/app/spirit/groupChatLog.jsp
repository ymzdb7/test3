                                ...
                                if(arr[i].content !=''){
                                    ...
                                    if(JSON.stringify(arr[i].file) == "{}"){
                                        ...
                                        if(arr[i].file.thumbnail_url !=undefined){
                                            ...
                                            return '<img src="/xs?'+ arr[i].file.file_url+'" style="border: 1px solid #eee;margin-left: 10px;height: 130px;" onclick="doQtPer($(this))"><div class="jsonstring">'+ str_json +'</div>';
                                        }else{
            ...
            if(nums == 1){
                ...
                for(var i=0;i<json.obj1.length;i++){
                    ...
                    str +=   '<div class="main-content"> ' +
                        ...
                        '<div class="time-color" style="margin: 0 auto;width: 110px;">2017-12-05 16:59</div> ' +
                        '</div>' +
                        '<ul>'+str1+'</ul>' +
                        '</div>'
                }
