...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('.export').click(function () {
            window.open("<%=basePath%>department/outputDepartment")
        });
            ...
            if (flag) {
                $('#uploadForm').ajaxSubmit({
                    ...
                    success: function (res) {
                        var data=res.object;
                        if(res.flag) {
                            var str='导入成功'+data.successCount+"条数据，失败"+data.failCount+"条数据。";
