                            ...
                            if(v.userId) {
                                ...
                                if(v.sex==0){
                                    divObj = $('<div class="block-right-item '+function () {
                                        ...
                                        }()+'" item_id="'+v.uid+'" item_name="'+v.userName+'" id="'+v.uid+'" user_id="'+v.userId+'" uid="'+v.uid+'" userPrivName="'+v.userPrivName+'" title="'+v.userName+'"><span class="name">'+v.userName+' '+v.userPrivName+'<span class="status"> </span></span></div>');
                                }else if(v.sex==1){
                                    divObj = $('<div class="block-right-item '+function () {
                                            if(user_id) {
                                                var user_idArr;
            ...
            function buildDefaultItem(){
				...
				if(user_id && dataid && selectItemsName && userPrivName){
                    ...
                    for(var i=0;i<user_id.length;i++){
                        if(user_id[i]) {
                            arr += '<div class="block-right-item active"  userprivname="'+userPrivName[i]+'"  item_id="' + dataid[i] + '" item_name="' + selectItemsName[i] + '"  id="' + dataid[i] + '"  user_id="' + user_id[i] + '" uid="' + dataid[i] + '" title="' + selectItemsName[i] + '"><span class="name">' + selectItemsName[i] + ' ' + userPrivName[i] + '<span class="status"></span></span></div>';
                        }
					}
					...
					if(v.deptId){
                        ...
                        if(v.sex==0){
							tr+='<div class="block-right-item '+function () {
                                ...
                                }()+'" item_id="'+v.uid+'" userPrivName="'+v.userPrivName+'" item_name="'+v.userName+'" id="'+v.uid+'" user_id="'+v.userId+'" uid="'+v.uid+'" title="'+v.userName+'"><span class="name">'+v.userName+' '+v.userPrivName+'<span class="status"> </span></span></div>';
						}else if(v.sex==1){
							tr+='<div class="block-right-item '+function () {
                                    if(user_id) {
