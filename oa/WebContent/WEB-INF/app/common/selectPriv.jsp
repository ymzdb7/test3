...
//                    buildPrivList(node.id);
                ...
                success:function(obj){
                    if(obj.flag){
                        ...
                        data.forEach(function(v,i){
							...
							}()+'" id="'+v.privNo+'" privId="'+v.privNo+'" privName="'+v.privName+'" userPriv="'+v.userPriv+'"title="'+v.privName+'"><span class="name">'+v.privName+'<span class="status"> </span></span></div>';
                        });
    ...
    function autodivheights(text) {
        $.ajax({
            type: "get",
            url: "../userPriv/getBySearch?search=" + text,
            dataType: 'JSON',
            success: function (res) {
                if(res.flag){
                    ...
                    var tr = '';
                    data.forEach(function(v,i){
                        tr+='<div class="block-right-item" id="'+v.privNo+'" privId="'+v.privNo+'" privName="'+v.privName+'" userPriv="'+v.userPriv+'"title="'+v.privName+'"><span class="name">'+v.privName+'<span class="status"> </span></span></div>';
                    });
