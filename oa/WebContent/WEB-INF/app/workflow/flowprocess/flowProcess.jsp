						...
						success : function(rsp) {
							...
							for ( var i = 0; i < data.length; i++) {
								...
								str += '<tr class="TableLine1"><td nowrap align="center">'
										...
										+ '<fmt:message code="global.lang.edit" /></td>'
										+ '<td nowrap align="left"><a href="javascript:;" Id="'+data[i].id+'" class="windowOpen">'
										+ '<fmt:message code="global.lang.delete" /></td><td>'
		...
		<div id="notify" style="overflow-y: scroll;display:block;">
			<table border="0" width="95%" cellspacing="0" cellpadding="3"
				...
				<tr>
					<td class="Big"><img src="../img/notify_open.gif"
						align="absmiddle"> <span class="big3"><fmt:message code="workflow.th.design" /></span>&nbsp;
						<!-- <select name="TYPE"
			...
			<table class="TableList" width="95%" align="center" cellspacing="0"
				...
				<tr class="TableHeader">
					...
					<th nowrap align="center"><fmt:message code="workflow.th.Serial" /></th>
					<th nowrap align="center"><fmt:message code="workflow.th.name" />
					</th>
					<th nowrap align="center"><fmt:message code="workflow.th.nextstep" />
				</th>

					<th nowrap align="center" style="cursor:pointer;"><fmt:message code="notice.th.operation" />
				  ...
				  <option value="04"><fmt:message code="notice.type.other" /></option>
					...
					<tr>
						...
						<td class="TableData"><input class="laydate-icon" id="start">
							&nbsp;<fmt:message code="global.lang.to" />&nbsp; <input class="laydate-icon" id="end">
						</td>
					</tr>
					<tr>
