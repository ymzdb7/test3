    ...
    <div class="content">
        <div class="header clearfix">
            ...
            <div class="banRight">
                ...
                <div class="posit" id="android">
							<span class="iconT">
								<img src="../img/default/theme2/Android.png" title='<fmt:message code="main.th.Android" />'/>
							</span>
        ...
        <div class="mainCon">
            ...
            <div class="entry">
                <div class="entryTwo">
                    <div class="txt">
                        <img src="../img/default/theme2/icon_depart.png" style="margin-right: 13px;"/>
                        <span class="spanColor" style="vertical-align:middle;margin-right: -12px;color: #FFFFFF;letter-spacing: 5px;display: inline-block;width: 60px;"><fmt:message code="global.lang.tissue" /></span>
                    ...
                    <div class="txt">
                        <img class="img" src="../img/default/theme2/icon_user.png"/>
                        <span class="spanColor" style="vertical-align:middle;margin-left: 3px;color: #FFFFFF;margin-right: -12px;letter-spacing: 5px;display: inline-block;width: 60px;"><fmt:message code="journal.th.user" /></span>
                        <input type="text" style="margin-left:-3px;" name="user" id="user" value="" />
                    </div>
                    <div class="txt">
                        <img class="img" style="margin-left: 2px;" src="../img/default/theme2/icon_password.png"/>
                        ...
                        <input type="password" autocomplete="off" style="margin-left:-3px;" name="password" id="password" value="" />
                    </div>
                    <div class="loginBtn" style="    margin-left: 94px;margin-top: 39px;">
                        <span style="margin-left: 94px;"><fmt:message code="global.lang.login" /></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        $.get('/sys/getInterfaceInfo',function (json) {
            if(json.flag){
                if(json.object.attachment2.length!=0) {
                    ...
                    $('.header .logo img').attr('src','/img/default/theme2/LOGO.png')
                }
