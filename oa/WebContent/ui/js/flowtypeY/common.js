...
{
    var myleft=(screen.availWidth-800)/2;
    window.open("/general/workflow/query/data/archive_flow_view.php?FLOW_ID="+FLOW_ID+"&ARCHIVE_ID="+archive_id,"","status=0,toolbar=no,menubar=no,location=no,scrollbars=yes,resizable=yes,width=800,height=500,left="+myleft+",top=50");
}
...
function form_view(RUN_ID,FLOW_ID,PRCS_ID,archive_time)
{
    if(archive_time == "" || typeof(archive_time)=="undefined"){
        ...
        window.open("/general/workflow/list/print/?RUN_ID="+RUN_ID+"&FLOW_ID="+FLOW_ID+"&PRCS_ID="+PRCS_ID+"&archive_time="+archive_time,"","status=0,toolbar=no,menubar=no,width="+(screen.availWidth-12)+",height="+(screen.availHeight-38)+",location=no,scrollbars=yes,resizable=yes,left=0,top=0");
    }
...
{
    var myleft=(screen.availWidth-800)/2;
    // window.open("/general/workflow/query/data/flow_view/?RUN_ID="+RUN_ID+"&FLOW_ID="+FLOW_ID+"&ARCHIVE_ID="+ARCHIVE_ID,RUN_ID,"status=0,toolbar=no,menubar=no,location=no,scrollbars=yes,resizable=yes,width=800,height=400,left="+myleft+",top=100");
    window.open("/general/workflow/list/flow_view/?RUN_ID="+RUN_ID+"&FLOW_ID="+FLOW_ID+"&ARCHIVE_ID="+ARCHIVE_ID,RUN_ID,"status=0,toolbar=no,menubar=no,location=no,scrollbars=yes,resizable=yes,width=800,height=400,left="+myleft+",top=100");
}
...
function edit_run(RUN_ID,FLOW_ID)
{
    ...
    var url = "/general/workflow/query/list/input_form/?RUN_ID="+RUN_ID+"&MENU_FLAG=1&EDIT_MODE=1&FLOW_ID="+FLOW_ID;
...
function others(FLOW_ID,RUN_ID,PRCS_ID,FLOW_PRCS,FLOW_TYPE,FLOW_ENTRUST)
{
    ...
    if(FLOW_ENTRUST=="conceal"){ //我的工作
        window.open("/general/workflow/list/others/"+page+".php?RUN_ID="+RUN_ID+"&FLOW_ID="+FLOW_ID+"&PRCS_ID="+PRCS_ID+"&FLOW_PRCS="+FLOW_PRCS+"&FLOW_ENTRUST="+FLOW_ENTRUST,"others","status=0,toolbar=no,menubar=no,width=700,height=450,location=no,scrollbars=yes,resizable=no,left="+myleft+",top="+mytop);
    }else{
        window.open("/general/workflow/list/others/"+page+".php?RUN_ID="+RUN_ID+"&FLOW_ID="+FLOW_ID+"&PRCS_ID="+PRCS_ID+"&FLOW_PRCS="+FLOW_PRCS,"others","status=0,toolbar=no,menubar=no,width=700,height=450,location=no,scrollbars=yes,resizable=no,left="+myleft+",top="+mytop);
    }
}
