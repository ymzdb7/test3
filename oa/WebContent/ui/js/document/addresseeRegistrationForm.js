    ...
    $('.tableDl').delegate('[data-id="1"]','click',function () {
        ...
        (function (fn) {
            ...
            layer.open({
                ...
                '<p>' +
                '<label style="display: inline-block;width: 150px;vertical-align: middle;height: 30px;line-height: 30px;text-align: right;">'+titleShouwen+' :</label>' +
                ...
                yes:function (index) {
                    $.post('/document/saveDoc',{title:$('[name="nametitle"]').val(),flowId:urlid,
                        documentType:1,dispatchType:$('[name="dispatchType"]').val(),
