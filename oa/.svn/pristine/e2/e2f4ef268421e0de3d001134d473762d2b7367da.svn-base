                ...
                <%--$.get('/document/selWillDocSendOrReceive',me.data,function (json) {--%>
                    ...
                    <%--for(var i=0;i<arr.length;i++){--%>
                        <%--str+='<tr>' +--%>
                            ...
                            <%--'<td><p>第'+arr[i].step+'步：'+arr[i].prcsName+'</p>' +--%>
                            <%--'<p>'+function () {--%>
                            ...
                            <%--+'&runId='+arr[i].runId+'&tabId='+arr[i].id+'&tableName='+arr[i].tableName+'&isNomalType=false&hidden=true" target="_blank" style="margin-right: 10px"><fmt:message code="document.th.handle"/></a>' +--%>
