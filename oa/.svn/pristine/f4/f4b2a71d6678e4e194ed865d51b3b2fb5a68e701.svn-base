                    ...
                    $.ajax({
                        ...
                        success:function(res){
                            ...
                            if(res.flag==true){
                                if(data!=undefined){
                                    for(var i=0;i<data.length;i++){
                                        str+="<li class='proId' url='/officetransHistory/gpProApply?editFlag=0&transId=0&proid="+data[i].proId+"&depositoryid="+that.parents('.depositoryId').attr('depositoryid')+"&protypeid="+that.attr('protypeid')+"' proId='"+data[i].proId+"'>" +
