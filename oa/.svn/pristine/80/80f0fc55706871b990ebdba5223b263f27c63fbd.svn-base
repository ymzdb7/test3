   ...
   implements Serializable
 {
   ...
   {
     return this.loginType == null ? "" : this.loginType.trim();
   }
   ...
   {
     return this.isDefault == null ? "0" : this.isDefault.trim();
   }
   ...
   {
     return this.pop3Ssl == null ? "0" : this.pop3Ssl.trim();
   }
   ...
   {
     return this.smtpSsl == null ? "0" : this.smtpSsl.trim();
   }
   ...
   {
     return Integer.valueOf(this.quotaLimit == null ? 0 : this.quotaLimit.intValue());
   }
   ...
   {
     return this.priority == null ? "0" : this.priority.trim();
   }
   ...
   {
     return this.recvDel == null ? "0" : this.recvDel.trim();
   }
   ...
   {
     return this.recvRemind == null ? "1" : this.recvRemind.trim();
   }
   ...
   {
     return this.recvFw == null ? "" : this.recvFw.trim();
   }
   ...
   {
     return this.createUser == null ? "" : this.createUser.trim();
   }
   ...
   {
     return this.emailUid == null ? "" : this.emailUid.trim();
   }
