...
public class EduSchoolBusiness {
	private Integer notifyId;
	private String deptNameSp;
	...
	public String getDeptNameSp() {
		return this.deptNameSp;
	}

	public void setDeptNameSp(String deptNameSp) {
		this.deptNameSp = deptNameSp;
	}
	...
	public byte[] getCompressContent() {
		return this.compressContent == null ? new byte[0]
	...
	public Integer getFromDept() {
		return Integer.valueOf(this.fromDept == null ? 0 : this.fromDept
				.intValue());
	}
	...
	public Integer getBeginDate() {
		return Integer.valueOf(this.beginDate == null ? 0 : this.beginDate
				.intValue());
	}
	...
	public Integer getEndDate() {
		return Integer.valueOf(this.endDate == null ? 0 : this.endDate
				.intValue());
	}
	...
	public Integer getTopDays() {
		return Integer.valueOf(this.topDays == null ? 0 : this.topDays
				.intValue());
	}
	...
	public EduSchoolBusiness() {
	}

	public EduSchoolBusiness(String format, String fromId, Date sendTime,
			String subject, String content, String toId, String publish) {
		this.format = format;
		this.fromId = fromId;
		this.sendTime = sendTime;
