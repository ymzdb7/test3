...
<body>
<header>
    <i><a href="/dingdingMicroApp/newsh5" style="color: #fff">返回</a></i>
    <span>新闻详情</span>
            ...
            success:function(res){
                if(res.flag){
                    var app='<div>'+
                        ...
                        '<span class="fs14">类型：<a href="javascript:;" style="color: #5087d0">'+function(){if(res.object.typeName==''){return '无类型'}else{return  res.object.typeName}}()+'</a></span>'+
                        '</div>'+
