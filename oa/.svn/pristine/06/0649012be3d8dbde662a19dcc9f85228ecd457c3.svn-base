package com.myoa.model.department;
...
public class Department {
	...
	private Integer nameRepeat;
	private Integer noRepeat;
	private Integer nameRoNoNull;
	private Integer noParent;
	private List<Department> child;
	private List<Users> users;

	public Integer getSuccessCount() {
		return Integer.valueOf(this.successCount == null ? 0
				: this.successCount.intValue());
	}
	...
	public Integer getFailCount() {
		return Integer.valueOf(this.failCount == null ? 0 : this.failCount
				.intValue());
	}
	...
	public Integer getNameRepeat() {
		return Integer.valueOf(this.nameRepeat == null ? 0 : this.nameRepeat
				.intValue());
	}
	...
	public Integer getNoRepeat() {
		return Integer.valueOf(this.noRepeat == null ? 0 : this.noRepeat
				.intValue());
	}
	...
	public Integer getNameRoNoNull() {
		return Integer.valueOf(this.nameRoNoNull == null ? 0
				: this.nameRoNoNull.intValue());
	}
	...
	public Integer getNoParent() {
		return Integer.valueOf(this.noParent == null ? 0 : this.noParent
				.intValue());
	}
	...
	public String getClassifyOrgAdminName() {
		return this.classifyOrgAdminName == null ? ""
	...
	public String getDeptParentName() {
		return this.deptParentName == null ? "" : this.deptParentName;
	}
	...
	public String getManager() {
		return this.manager == null ? "" : this.manager.trim();
	}
	...
	public String getAssistantId() {
		return this.assistantId == null ? "" : this.assistantId.trim();
	}
	...
	public String getLeader1() {
		return this.leader1 == null ? "" : this.leader1.trim();
	}
	...
	public String getLeader2() {
		return this.leader2 == null ? "" : this.leader2.trim();
	}
	...
	public String getDeptFunc() {
		return this.deptFunc == null ? "" : this.deptFunc.trim();
	}
	...
	public String getFaxNo() {
		return this.faxNo == null ? "" : this.faxNo.trim();
	}
	...
	public String getDeptNo() {
		return this.deptNo == null ? "" : this.deptNo.trim();
	}
	...
	public String getIsOrg() {
		return this.isOrg == null ? "" : this.isOrg.trim();
	}
	...
	public String getOrgAdmin() {
		return this.orgAdmin == null ? "" : this.orgAdmin.trim();
	}
	...
	public void setDeptEmailAuditsIds(String deptEmailAuditsIds) {
		this.deptEmailAuditsIds = (deptEmailAuditsIds == null ? ""
	...
	public String getManagerStr() {
		return this.managerStr == null ? "" : this.managerStr;
	}

	public String getAssistantStr() {
		return this.assistantStr == null ? "" : this.assistantStr;
	}

	public String getLeader1Name() {
		return this.leader1Name == null ? "" : this.leader1Name;
	}
	...
	public String getLeader2Name() {
		return this.leader2Name == null ? "" : this.leader2Name;
	}
