...
<link rel="stylesheet" type="text/css" href="css/default/loginInterface2.css" />
...
<body>
	...
	<div class="experience">
		<p>
			<fmt:message code="main.th.ExperienceAccount" />
			：
		</p>

		<p style="padding-left: 2em">
			<span>zhangwei</span> <label style="margin-left: 1em">董事长/CEO</label>
		</p>
		<p style="padding-left: 2em">
			<span>wangfang</span> <label style="margin-left: 1em">人事部</label>
		</p>
		<p style="padding-left: 2em">
			<span>liuyang</span> <label style="margin-left: 1em">财务部</label>
		</p>
		<p style="padding-left: 2em">
			<span>lihua</span> <label style="margin-left: 1em">研发部</label>
		</p>
		<p style="padding-left: 2em">
			<span>wangli</span> <label style="margin-left: 1em">研发一组</label>
		</p>
		<p style="padding-left: 2em">
			<span>wanghai</span> <label style="margin-left: 1em">研发一组</label>
		</p>
		<p style="padding-left: 2em">
			<span>baixue</span> <label style="margin-left: 1em">客服中心</label>
		</p>
		<p style="padding-left: 2em">
			<span>wangqiang</span> <label style="margin-left: 1em">生产部</label>
		</p>
		<p>
			<fmt:message code="main.th.FriendshipTips" />
			：
		</p>
		<p style="padding-left: 2em">
	...
	<form name="form1">
		<div class="content">
			<div class="header clearfix">
				<div class="logo">
					<img src="img/default/theme1/LOGO.png" />
				</div>
				<div class="banRight">
					<span class="banLang"><fmt:message code="language" />：</span> <select
						id="language" name="language"
						style="width: 60px; height: 23px; margin-right: 30px;">
						<option value="?lang=zh_CN">中文</option>
						<option value="?lang=en_US">English</option>
						<option value="?lang=zh_tw">繁体</option>
					</select> <span class="icon"> <a id="pcdownload" href=""> <img
							src="img/default/pc.png"
							title='<fmt:message code="main.th.pc" />' />
					</a>
					</span>
					<div class="posit" id="android">
						<span class="iconT"> <img
							src="img/default/theme1/Android.png"
						...
						<div class="QRCode codeT" style="display: none;">
							<img style="margin-left: 10px; margin-top: 10px;"
								src="img/default/sy07.png" />
						</div>
					</div>
					<div class="posit" id="iphone">
						<span class="iconH"> <img src="img/default/Apple.png"
				...
				<div class="entry">
					...
					<div class="entryBg">
						<div class="mainLeft">
							...
							<div class="desktop">
								<img src="img/default/computer.png" alt="">
							</div>
						</div>
						...
						<div class="mainRight">
							<div class="txt">
								<div class="imgDiv">
									<img src="img/default/icon_organination_2.png" />
								</div>
							...
							<div class="txt">
								<div class="imgDiv">
									<img class="img" src="img/default/icon_user_2.png" />
								</div>
							...
							<div class="txt">
								<div class="imgDiv">
									<img class="img" src="img/default/icon_password_2.png" />
								</div>
							...
							<div class="loginBtn">
								<span style="margin-left: 52px;"><fmt:message
										code="global.lang.login" /></span>
							</div>
						</div>
					</div>
				</div>
	...
	<div id="beianhao"
		style="position: fixed; bottom: 0; left: 0; width: 100%; height: 50px; mso-font-src: 14px">
		<p style="text-align: center; margin-bottom: 5px">
			<a class="pone" target="_blank"
				style="color: #fff; text-decoration: none; height: 19px;"
        ...
        $.get('sys/getInterfaceInfo',function (json) {
            if(json.flag){
                ...
                if(json.object.loginLiterals!='') {
                    $('.mainLefttext').text(json.object.loginLiterals)
