   ...
   implements BinaryEncoder, BinaryDecoder
 {
   ...
   protected byte[] ensureBufferSize(int size, Context context) {
     return (context.buffer != null) && (context.buffer.length >= context.pos + size) ? context.buffer : resizeBuffer(context);
   }
   ...
   public Object encode(Object obj) throws EncoderException
   {
     ...
     return encode((byte[])(byte[])(byte[])obj);
   }
   ...
   public Object decode(Object obj) throws DecoderException {
     if ((obj instanceof byte[]))
       return decode((byte[])(byte[])(byte[])obj);
   ...
   public boolean isInAlphabet(byte[] arrayOctet, boolean allowWSPad) { for (int i = 0; i < arrayOctet.length; i++) {
   ...
   static class Context { int ibitWorkArea;
     ...
     public String toString() { return String.format("%s[buffer=%s, currentLinePos=%s, eof=%s, ibitWorkArea=%s, lbitWorkArea=%s, modulus=%s, pos=%s, readPos=%s]", new Object[] { getClass().getSimpleName(), this.buffer, Integer.valueOf(this.currentLinePos), Boolean.valueOf(this.eof), Integer.valueOf(this.ibitWorkArea), Long.valueOf(this.lbitWorkArea), Integer.valueOf(this.modulus), Integer.valueOf(this.pos), Integer.valueOf(this.readPos) });
     }
   }
 }
