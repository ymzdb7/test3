 package com.myoa.model.modulePriv;
 
 public class ModulePriv
 {
   private Integer uid;
   ...
   public String getDeptId() {
     return this.deptId == null ? "" : this.deptId.trim();
   }
   ...
   public String getPrivId() {
     return this.privId == null ? "" : this.privId.trim();
   }
