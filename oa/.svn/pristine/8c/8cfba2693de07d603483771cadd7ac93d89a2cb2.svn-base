...
<head lang="en">
    <meta charset="UTF-8">
    <title><fmt:message code="event.th.EndVehicle" /></title>
...
<div class="content">
    <div class="header">
        <div class="title">
            ...
            <span class="big3"><fmt:message code="event.th.EndVehicle" /></span>
        </div>
    </div>
    <div class="main">
            ...
            success: function (result) {
                ...
                for(var i=0;i<arr.length;i++){
                    str+='<tr>'+
                        ...
                        '<a href="../../veHicle/vehicleUseApply?editFlag=1&sign=5&vuId='+arr[i].vuId+'"><fmt:message code="depatement.th.modify" /></a>' +
