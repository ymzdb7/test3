...
<table border="0" width="90%" cellspacing="0" cellpadding="3" class="small" style="margin-top: 24px;">
    <tr>
        <td class="Big" style="padding: 19px 0;border:none"><img align="absMiddle" src="/img/commonTheme/${sessionScope.InterfaceModel}/infofind11.png" style="margin-left: 35px;margin-bottom: 2px;"><span class="big3" style="font-family: 微软雅黑;font-size: 22px;margin-left: 10px;"> <fmt:message code="hr.th.inquiry" /></span></td>
    </tr>
</table>
<div class="show_list">
    <table id="TableBlock" class="TableBlock" width="820" align="center" style="border: 1px solid #ddd;">
        ...
        <tr class="TableHeader" height="25" style="background: #e8f4fc" >
        ...
        <tr align="center" class="TableControl">
            <td colspan="6" style="cursor: pointer;">
                <div id="btn_query" style="cursor: pointer;" class="find_submit BigButton" onclick="findSubmit()"><h2><fmt:message code="global.lang.query" /></h2></div>
            </td>
        </tr>
    </table>
</div>
...
<div class="find_list" style="display:none">
    <table class="fList" id="flist" width="100%" style="border: 1px solid #ccc;">
    ...
    <div class="table_personDetail" id="table_personDetail" style="display: none;">
        <table class="TableBlock" width="100%" align="center">
            ...
            <tr style="margin-top:30px;">
                <td nowrap="" class="TableData" width="100" style="padding-top: 40px;">OA<fmt:message code="global.lang.user" />：</td>
                <td class="TableData" width="180" colspan="3"  style="padding-top: 40px;">
                    <input type="hidden" name="UID" value="" id="UID" class="uid">
                    <input type="text" name="USER_ID" disabled="disabled" value="" id="USER_ID" class="user_id test_null">
                    <input type="hidden" name="staffId" class="staffId"/>
            ...
            <tr>
                ...
                <td class="TableData" colspan="2" title="<fmt:message code="hr.th.ID" />">
                    ...
                    <input type="checkbox" name="IS_LUNAR" id="IS_LUNAR" value="1" style="margin-left: 13px;margin-top: 4px;" class="per_noneli" onclick="get_animal_sign()">
            ...
            <tr>
                ...
                <td class="TableData" width="180" colspan="5" style="padding-bottom: 40px;">
                    <form method="post" action="" enctype="multipart/form-data" id="photoForm"><span id="showImage"></span>
                        <input type="file" name="imageFile" id="imageFile" size="40" class="BigInput" title="选择附件文件">&nbsp;<span>照片文件只能是gif、png、jpg、bmp格式!</span>
                    </form>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td nowrap="" class="TableData" width="100"><fmt:message code="userDetails.th.post" />：</td>
                <td class="TableData" width="180" style="text-align: left;"><input type="text" name="JOB_POSITION" class="BigInput per_zhiwu" value=""></td>
                <td nowrap="" class="TableData" width="100"><fmt:message code="hr.th.Title" />：</td>
                <td class="TableData" width="180">
                    <select name="PRESENT_POSITION" class="BigSelect per_zhicheng" title="职称可在“人力资源设置”->“HRMS代码设置”模块设置。">
                        <option value="" selected=""></option>
                        <option value="08"><fmt:message code="hr.th.SeniorTitles" /></option>
                        <option value="02"><fmt:message code="hr.th.AssistantEngineer" /></option>
                        <option value="01"><fmt:message code="hr.th.Engineer" /></option>
                ...
                <td nowrap="" class="TableData" width="100"><fmt:message code="hr.th.InductionTime" />：</td>
                <td class="TableData" width="180">
                    <input type="text" name="DATES_EMPLOYED" size="10" maxlength="10" class="BigInput per_ruzhiTime" value="" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td nowrap="" class="TableData" width="100"><fmt:message code="hr.th.LengthUnit" />：</td>
                <td class="TableData" width="180"><input type="text" name="JOB_AGE" class="BigInput per_gongling" value=""></td>
                <td nowrap="" class="TableData" width="100"><fmt:message code="hr.th.StartingSalary" />：</td>
                <td class="TableData" width="180">
            ...
            <tr>
                <td nowrap="" class="TableData" width="100"><fmt:message code="hr.th.TotalLengthOfService" />：</td>
                <td class="TableData" width="180"><input type="text" name="WORK_AGE" value="" class="BigInput per_allage"></td>
                <td nowrap="" class="TableData" width="100"><fmt:message code="hr.th.WorkingHours" />：</td>
                <td class="TableData" width="180">
                    <input type="text" name="JOB_BEGINNING" size="10" maxlength="10" class="BigInput per_joinWork" value="" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})" onchange="get_work_age(this.value)">
                </td>
                <td nowrap="" class="TableData" width="100"><fmt:message code="hr.th.ContactNumber" />：</td>
            ...
            <tr>
                <td nowrap="" class="TableData" width="100" style="padding-top: 40px;"><fmt:message code="hr.th.Education" />：</td>
                <td class="TableData" width="180" style="padding-top: 40px;">
                    <select name="STAFF_HIGHEST_SCHOOL" class="BigSelect per_xueli" title="<fmt:message code="hr.th.TheEducation" />。">
                        <option value="" selected=""></option>
                    ...
                    if(data.length>0){
                        for(var i=0;i<data.length;i++){
                            ...
                            if(data[i].staffPoliticalStatus=="1"){
                                staffPoliticalStatusName='群众';
                            }else if(data[i].staffPoliticalStatus=="2"){
                                staffPoliticalStatusName='共青团员';
                            }else if(data[i].staffPoliticalStatus=="3"){
                                staffPoliticalStatusName='中共党员';
                            }else if(data[i].staffPoliticalStatus=="4"){
                                staffPoliticalStatusName='中共预备党员';
                            }else if(data[i].staffPoliticalStatus=="5"){
                                staffPoliticalStatusName='民主党派';
                            }else{
                                staffPoliticalStatusName='无党派人士';
                            }
                            var txt=data[i].staffSex==0?'男':'女';

                            /* var photo=data[i].photo==''?'未上传':data[i].photo;
                             var photoName=data[i].photoName==''?'未上传':data[i].photoName;*/
                            var photo=data[i].photo==''?'未上传':'已上传';
                            var photoName=data[i].photoName==''?'未上传':'已上传';
                        ...
                        var thea='<thead class="TableHeader"><tr><td class = "th" nowrap="" align="center" ><fmt:message code="global.lang.select" /></td><td class = "th" nowrap="" align="center"><fmt:message code="userDetails.th.name" /></td>'
                            +'<td class = "th" nowrap="" align="center"><fmt:message code="interfaceSetting.th.UserAvatar" /></td><td class = "th" nowrap="" align="center"><fmt:message code="HR.TH.FileAvatar" /></td><td class = "th" nowrap="" align="center">OA<fmt:message code="userManagement.th.role" /></td>'
                            +'<td class = "th" nowrap="" align="center"><fmt:message code="userDetails.th.Gender" /></td><td class = "th" nowrap="" align="center"><fmt:message code="hr.th.DateOfBirth" /></td><td class = "th" nowrap="" align="center"><fmt:message code="hr.th.Nation" /></td><td class = "th" nowrap="" align="center"><fmt:message code="hr.th.PlaceOfOrigin" /></td>'
                            +'<td class = "th" nowrap="" align="center"><fmt:message code="hr.th.PoliticalOutlook" /></td><td class = "th" nowrap="" align="center" width="132"><fmt:message code="hr.th.InductionTime" /></td><td class = "th" align="center" width="150"><fmt:message code="menuSSetting.th.menuSetting" /></td></tr></thead>'

                        $('#TableBlock').hide();
                        $('#flist').html(thea+str);
                        $(".find_list").append('<div class="checkOper" style=" text-align:center;margin-top:10px"><input type="checkbox" name="hrms_select" style="margin-left: 3%;" id="checkedAll"><fmt:message code="notice.th.allchose" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0);" class="delete_check delButMul"><fmt:message code="global.lang.delete" /></a></div>');
//                        console.log(str);
                    }else{
                        layer.msg('无符合条件的人事档案', {icon: 6});
                    }
    ...
    $('.fList').on('click','.delBtnSingle',function () {
        ...
        layer.confirm('确定要删除吗？', {
            ...
            $.ajax({
                ...
                success:function(obj){
                    if(obj.flag){
                        $.layerMsg({content: '删除成功！', icon: 6}, function () {
                            findSubmit();
                        })
                    }
                }
    ...
    $('.find_list').on('click','.delButMul',function () {
        if($(".checkChild:checkbox:checked").length<=0){
            $.layerMsg({content: '请进行选择！', icon: 2}, function () {
            })
            return;
        }
        var staffIdStr="";
    ...
    $('#add_send').on('click', function () {
        ...
        for(var i=0; i< array.length; i++){
            if(array[i].value==""){
                $.layerMsg({content:"带*的不能为空",icon: 2}, function(){
                });
                return;
            }
        }
...
//                    findSubmit();
    ...
    $("#leave_baocun").click(function () {
        ...
        for (var i = 0; i < array.length; i++) {
            if (array[i].value == "") {
                $.layerMsg({content: "带*号的不能为空", icon: 2}, function () {
                });
                return;
            }
        }
