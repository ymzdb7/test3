...
var codebase="../lib/officecontrol/OfficeControl.cab#version=5,0,2,8";
var codebase64="../lib/officecontrol/OfficeControl.cab#version=5,0,2,8";
...
if (browser=="IE"){
	...
	if(window.navigator.platform=="Win32"){
		...
		document.write('<param name="ProductCaption" value="北京高速波软件有限公司"> ');
		document.write('<param name="ProductKey" value="40572A143F1DAF56B575903493E284C98618333B">');
	...
	if(window.navigator.platform=="Win64"){
		...
		document.write('_ProductCaption="北京高速波软件有限公司" ');
		document.write('_ProductKey="40572A143F1DAF56B575903493E284C98618333B"');
		...
		document.write('<div class="no-control-msg"><img src="/img/document/word_aip/icon_err_msg_03.png" ><SPAN>您尚未安装跨浏览器控件，请<a href="../lib/officecontrol/OfficeOnlineTools.msi">点击</a>下载安装。</SPAN></div>   ');
		document.write('</object>');
	}else if (Sys.opera){
