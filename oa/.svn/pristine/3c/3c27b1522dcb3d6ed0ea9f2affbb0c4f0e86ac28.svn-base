...
<div class="head w clearfix">
    <ul class="index_head">
        ...
        <li data-num="2"><span class="headli3 allwork one"  id="allwork"><fmt:message code="workflow.th.allwork" /></span><img src="../../img/twoth.png" alt="" class="headli2_2"></li>
        </li>
    </ul>
</div>
<div class="body" style="width: 100%;margin-top: 44px">
    <div class="bx">
        <div class="navigation  clearfix">
            <div class="left">
                <img src="/img/commonTheme/${sessionScope.InterfaceModel}/quanbugongzuo.png">
                <div class="news"><fmt:message code="workflow.th.allwork" /></div>
                <input id="flow_search_value_qb" class="inp" type="text" placeholder="&nbsp;<fmt:message code="workflow.th.Searchforname" />">
                <div id="btn_search" class="search"><h1 style="cursor:pointer;" class="subsearch" id="qbgz_search"><fmt:message code="workflow.th.sousuo" /></h1></div>
            </div>
...
//                return '转交下一步，下一步经办人无人接收';
    ...
    var pageObj=$.tablePage('#pagediv','1084px',[
        {
            width:'97px',
        ...
        {
            width:'98px',
            title:'<fmt:message code="workflow.th.flowtype"/>',
            name:'prcsFlag',
            selectFun:function (prcsFlag,obj) {
                return obj.flowType.flowName;
            }
        },
        {
            width:'289px',
        ...
        },
        {
            ...
            width:'135px',
            title:'<fmt:message code="workflow.th.wjblct"/>',
            name:'prcsId',
            ...
            width:'87px',
            title:'<fmt:message code="workflow.th.Stepstatus"/>',
            name:'prcsFlag',
            selectFun:function (prcsFlag,obj) {
        ...
        me.init('../../workflow/work/selectAll',[{name:'<fmt:message code="roleAuthorization.th.ViewDetails" />',fn:function(obj){
            return  1;
        }}])
    })
    ...
    $('#qbgz_search').click(function () {
        pageObj.data.myworkconditions=$("#flow_search_value_qb").val();
        pageObj.init();
    })
</script>
