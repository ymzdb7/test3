...
<div class="export_div1">
    <p class="bumen_dc"><img src="../../img/import/department_export.png" alt=""><span class="zisize">学籍信息导出</span></p>
    <div class="juzhong"><input type="button" class="export" value='导出' /></div>
</div>
<div class="import_div2">
    <p class="bumen_dc"><img src="../../img/import/department_import.png" alt=""><span class="zisize">学籍信息导入</span></p>
    <form class="form1" name="form1" id="uploadForm" method="post" action="/schoolRoll/importSchoolRollInfo" enctype="multipart/form-data" >
        <table>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('.export').click(function () {
            window.open("/schoolRoll/outputSchoolRollInfo")
        });

        $('#modle').click(function () {
            window.location.href="/file/edu/eduSchool/学籍信息导出.xls"
        });
