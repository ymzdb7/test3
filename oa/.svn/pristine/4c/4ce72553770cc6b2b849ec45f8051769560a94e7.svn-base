...
//初始化区域图的对象
    ...
    if (property.haveTool) {
        ...
        this.$tool.append("<a href='javascript:void(0)' class='GooFlow_tool_btndown' " +
            ...
            "<b class='ico_cursor'/><label>选择工具</label>" +
            "</a>" +
            "<a href='javascript:void(0)' class='GooFlow_tool_btn' " +
            "id='" + this.$id + "_btn_direct'><b class='ico_direct'/><label>节点连线</label>" +
            "</a>" +
            "<a href='javascript:void(0)' class='GooFlow_tool_btn' id='" + this.$id + "_btn_start'>" +
            "<b class='ico_start'/><label>流程开始节点</label>" +
        ...
        if (property.toolBtns && property.toolBtns.length > 0) {
            ...
            for (var i = 0; i < property.toolBtns.length; ++i) {
                tmp += "<a href='javascript:void(0)' id='" + this.$id + "_btn_" + property.toolBtns[i] + "' class='GooFlow_tool_btn'><b class='ico_" + property.toolBtns[i] + "'/>" +
                    "<label>"+function () {
    ...
    this.$bgDiv.append("<div class='GooFlow_work' style='width:" + (widthint-240) + "px;height:" + (heightint-$('.GooFlow_head').height()-7) + "px;" + (property.haveHead ? "" : "margin-top:3px") + "'></div>");
...
GooFlow.prototype = {
    ...
    addNode: function (id, json) {
        ...
        if (json.type != "start" && json.type != "end") {
            ...
            this.$nodeDom[id] = $("<div class='GooFlow_item" + mark + "' id='" + id + "' style='top:" + json.top + "px;left:" + json.left + "px'><table cellspacing='1' style='width:" + (json.width - 2) + "px;'><tr><td class='ico' style='position: relative;z-index: 999;'><b style='display: inline-block;width:" + (json.width - 2) + "px;' class='ico_" + json.type + "'></b></td><td class='tdwidth' style='position: relative;z-index: 888'>" + json.name + "</td></tr></table><div style='display:none'><div class='rs_bottom'></div><div class='rs_right'></div><div class='rs_rb'></div><div class='rs_close'></div></div></div>");
    ...
    delNode: function (id,type) {
        ...
        var metwo=this;
        $.post('/flowProcess/delete',{'id':$('#ele_designerId').val(),prcsId:$('[name="prcsId"]').val()},function (json) {
            if(json.flag) {
                location.reload();
            }
        },'json')
