package com.myoa.dao.salary.bonus;

import com.myoa.model.salary.bonus.Bonus;
import com.myoa.model.salary.bonus.BonusExample;
...
public abstract interface BonusMapper {
	...
	public abstract int updateByExampleSelective(
			@Param("record") Bonus paramBonus,
			@Param("example") BonusExample paramBonusExample);

	public abstract int updateByExample(@Param("record") Bonus paramBonus,
			@Param("example") BonusExample paramBonusExample);
