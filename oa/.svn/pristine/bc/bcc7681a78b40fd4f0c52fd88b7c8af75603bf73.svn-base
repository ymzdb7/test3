...
<form name="form1" method="post" >
    <table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
        <tr>
            <td class="Big"><img src="../img/notify.gif" align="absmiddle"><span class="big3"> 查阅情况</span>
    ...
    <tr align="center">
        <td colspan="2" nowrap><input class="BigButton" onClick="window.close();" type="button" value="确定"/>&nbsp;&nbsp;
        ...
        $(function(){
                ...
                success: function (obj) {
                  ...
                  /*  var  departmentData= digui(res,0);
                    ...
                    if(obj.flag==true){
                        ...
                        var head='<thead><tr><td class="TableContent" align="right" colspan="3"><u title="部门：北方测试研究公司" style="cursor:hand" class="userName">'+data.name+'</u>&nbsp;&nbsp;'+
                            '发布于：<i class="sendDate">'+data.notifyDateTime+'</i></td></tr><tr class="TableHeader">'+
            ...
            $('.SmallButton').on('click',function() {
                layer.confirm('确定清空查阅情况？', {
                    ...
                    //确定删除，调接口
                    $.ajax({
                        url: '/eduSchoolBusiness/EduQuerySituation',
                        type: 'post',
                        data: {
                            notifyId: notifyId,
                            readers:''
