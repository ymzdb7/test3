package com.myoa.controller.department;
...
public class DepartmentController {
	...
	public ToJson<Department> getDeptByid(int deptId, HttpServletRequest request) {
		...
		try {
			...
			if (!com.myoa.util.common.StringUtils.checkNull(
				...
				if (!com.myoa.util.common.StringUtils.checkNull(assistantStr)
						.booleanValue()) {
			...
			if (!com.myoa.util.common.StringUtils.checkNull(
				...
				if (!com.myoa.util.common.StringUtils.checkNull(leader1Name)
						.booleanValue()) {
			...
			if (!com.myoa.util.common.StringUtils.checkNull(
				...
				if (!com.myoa.util.common.StringUtils.checkNull(leader2Name)
						.booleanValue()) {
			...
			if (!com.myoa.util.common.StringUtils.checkNull(
				...
				if (!com.myoa.util.common.StringUtils.checkNull(orgAminName)
						.booleanValue()) {
	...
	public AjaxJson getChDeptUser(HttpServletRequest request) {
		...
		try {
			...
			if (com.myoa.util.common.StringUtils.checkNull(deptId)
					.booleanValue()) {
