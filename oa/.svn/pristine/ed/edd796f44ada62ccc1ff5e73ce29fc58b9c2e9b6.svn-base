...
<div class="query">
    <div class="title">
        <img src="../../img/book/returnBook.png" alt="">
        <span>还书管理</span>
    </div>
    <div class="table">
        <table>
            <tr>
                ...
                <td>
                    <input type="text" class="number" id="user"   disabled="disabled" id="borrower">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="text" class="beginTime" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})">
...
//            window.open('/bookManager/selectBook','_blank','width=800,height=700,top=100px,left=200px')
        ...
        var ajaxPageLe={
            ...
            page:function () {
                ...
                $.ajax({
                    url:'/bookManage/selByStatusManage',
                    type:'get',
                    ...
                    success:function(reg){
                        ...
                        for(var i=0;i<datas.length;i++){
                            ...
                            str += '<tr id="'+datas[i].borrowId+'">' +
                                ...
                                '<td>'+ function () {
                                    if(datas[i].status==0){
                                        return '<a href="javascript:;" class="return" style="margin-top:0px" onclick="upManage('+datas[i].borrowId+',1,3)">还书</a>';
                                    }else {
                                        return '<a href="javascript:;" class="return" style="margin-top:0px" onclick="upManage('+datas[i].borrowId+',3,1)">删除并存为历史记录</a>';
                                    }
                                }()+ '</td>' +
                                '                </tr>'
                        }
...
//    })
    ...
    // 还书：status=0  删除：deleteFlag=1
    function upManage(borrowId,status,deleteFlag) {
        $.ajax({
