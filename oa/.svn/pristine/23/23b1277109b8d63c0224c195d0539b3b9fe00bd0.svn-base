    ...
    <div class="content">
            ...
            <div class="banRight">
                ...
                <div class="posit" id="android">
                    ...
                    <div class="QRCode codeT" style="display: none;">
                        <img style="margin-left: 10px;margin-top: 10px;" src="../img/def ault/sy07.png"/>
                    </div>
                </div>
        ...
        <div class="mainCon">
            ...
            <div class="entry">
                <div class="entryTwo">
                    <div class="txt">
                        <img src="../img/default/theme5/icon_depart.png"/>
                    ...
                    <div class="txt">
                        <img class="img" src="../img/default/theme5/icon_user.png"/>
                    ...
                    <div class="txt">
                        <img class="img" src="../img/default/theme5/icon_password.png"/>
                    ...
                    <div class="loginBtn"  style="margin-left:93px;margin-top: 39px;">
    ...
    $(function () {
        ...
        $.get('/sys/getInterfaceInfo',function (json) {
            if(json.flag){
                ...
                document.object.title=json.object.loginLiterals;
